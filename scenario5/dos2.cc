...
int main (int argc, char **argv)
{
  ...
  csmaE.SetChannelAttribute ("DataRate", StringValue ("200Gbps"));
 ...
 staticRouting = Ipv4RoutingHelper::GetRouting <Ipv4StaticRouting> (e3->GetObject<Ipv4> ()->GetRoutingProtocol ());
  ...
  NS_LOG_INFO ("Create Applications.");
   ...
   /*Check here for bugs*/
    ...
    Time interPacketIntervalB1 = Seconds (0.00006);
    Time interPacketIntervalB = Seconds (0.0006);
    uint32_t maxPacketCountB = 120000000;
    uint32_t MaxPacketSizeB = 1024;
    ...
    clientB.SetAttribute ("PacketSize", UintegerValue (MaxPacketSizeB));
    ...
    clientB1.SetAttribute ("PacketSize", UintegerValue (MaxPacketSizeB));
